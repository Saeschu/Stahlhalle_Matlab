...
%Träger
txtBauDimT = uicontrol('Style','text',...
...
%Stütze         
txtBauDimS = uicontrol('Style','text',...
...
if b > 39
    msgbox('Die gewählte Gesammtspannweite der Lagerhalle [Breite], überschreitet die zulässige maximalspannweite von 39m. Berechnung mit mehr als 4 Stützenreihen bzw. 3 Bögen ist zur zeit nicht möglich.',...
        'Infobox')
    return 
end
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
zlabel('z - Höhe')
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
set(f2,'Name', 'Darstellung Lagerhalle 3D', 'NumberTitle', 'off','position', [800 438 750 420])
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
