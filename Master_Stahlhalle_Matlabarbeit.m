function mygui()
f1= figure('Name', 'Input Window', 'NumberTitle', 'off','MenuBar', 'None','position', [550 450 770 420], 'color', 'w', 'resize', 'off', 'nextPlot', 'new')
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%         
...
if K==1
f= figure('Name','Erster und Letzter Bogen')
else %K==2
f= figure('Name','Zweiter bis zweitletzter Bogen')
end
...
dQ=0.25                                         %Faktor der Höhenlast Darstellung                                         %Linienlast muss noch richtigen Buchstaben haben 
Q=q*dQ
...
text((MSupSL(2)*dM),-1,num2str(roundn(MSupSL(2),-2)))  %Text unten Ma !!! Wert -1 !!!
...
plot([ba,ba-MSupSR(2)*dM],[h,h],'r','LineWidth',2)       %Stab-Moment Ergänzung oben
...
plot([ba,ba],[h,h-MSupSR(2)*dM],'r','LineWidth',2)        %Stab-Moment Ergänzung rechts
text(-1+MSupSL(1)*dM,h+1-MSupSL(1)*dM,num2str(roundn(MSupSL(1),-2)))               %Text Ml !!! +1 % -1!!!
text(ba-MSupSR(2)*dM,h-MSupSR(2)*dM,num2str(roundn(MSupSR(2),-2)))                  %Text Mr
...
text(VSupSL(1)*dV,h*0.5,num2str(roundn(VSupSL(1),-2)))             %Text Stab Links !!!  !!!

%Querkraftverlauf Stab Rechts
plot([ba-VSupSR(1)*dV,ba-VSupSR(1)*dV],[0,h],'b','LineWidth',2)            %Querkraft Stab links
plot([ba,ba-VSupSR(1)*dV],[0,0],'b','LineWidth',2)                      %Querkraft Stab links Ergänzunglinie unten
plot([ba,ba-VSupSR(1)*dV],[h,h],'b','LineWidth',2)                      %Querkraft Stab links Ergänzunglinie oben
text(ba-VSupSR(1)*dV,h*0.5,num2str(roundn(VSupSR(1),-2)))             %Text Stab Links !!!  !!!
...
text(-NSupSL(1)*dN,h*0.5,num2str(roundn(NSupSL(1),-2)))                %Text Stab Links !!!  !!!

%Normalkraftverlauf Stab Rechts
plot([ba-NSupSR(1)*dN,ba-NSupSR(1)*dN],[0,h],'g','LineWidth',2)            %Normalkraft Stab rechts
plot([ba,ba-NSupSR(1)*dN],[0,0],'g','LineWidth',2)                      %Normalkraft Stab rechts Ergänzunglinie unten
plot([ba,ba-NSupSR(1)*dN],[h,h],'g','LineWidth',2)                      %Normalkraft Stab rechts Ergänzunglinie oben
text(ba-NSupSR(1)*dN,h*0.5,num2str(roundn(NSupSR(1),-2)))                  %Text Stab Links !!!  !!!

%Querkraftverlauf Stab Mitte
if AZB==2
plot([(1/AZB)*ba-NSupS1(1)*dN,(1/AZB)*ba-NSupS1(1)*dN],[0,h],'g','LineWidth',2)            %Normalkraft Stab rechts
plot([(1/AZB)*ba,(1/AZB)*ba-NSupS1(1)*dN],[0,0],'g','LineWidth',2)                      %Normalkraft Stab rechts Ergänzunglinie unten
plot([(1/AZB)*ba,(1/AZB)*ba-NSupS1(1)*dN],[h,h],'g','LineWidth',2)                      %Normalkraft Stab rechts Ergänzunglinie oben
text((1/AZB)*ba-NSupS1(1)*dN,h*0.5,num2str(roundn(NSupS1(1),-2)))                  %Text Stab Links !!!  !!!
elseif AZB==3
    
end
%Normalkraftverlauf Stab oben
plot([0,ba],[h+NSupSO(1)*dN,h+NSupSO(1)*dN],'g','LineWidth',2)            %Normalkraft Stab oben
plot([0,0],[h,h+NSupSO(1)*dN],'g','LineWidth',2)                      %Normalkraft Stab oben Ergänzunglinie unten
plot([ba,ba],[h,h+NSupSO(1)*dN],'g','LineWidth',2)                      %Normalkraft Stab oben Ergänzunglinie oben
text(ba*0.5,h+NSupSR(1)*dN,num2str(roundn(NSupSO(1),-2)))                  %Text Stab Links !!!  !!!
