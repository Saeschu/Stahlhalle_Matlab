...
dlg_title = 'Input';
num_lines = 1;
defaultans = {'20','27','3','0','4','0.2','0.3',''}; % Zahlenwerte können 'zwischen' entfert werden nur platzhalter
...
%Stuetze i2/3
vert3= [S2b XMVQ 0; S2b (XMVQ+ProfSt) 0; (S2b+ProfSb) (XMVQ+ProfSt) 0; (S2b+ProfSb) XMVQ 0; (S2b+ProfSb) (XMVQ+ProfSt) (h-2*ProfTh); (S2b+ProfSb) XMVQ (h-2*ProfTh); S2b XMVQ (h-2*ProfTh); S2b (XMVQ+ProfSt) (h-2*ProfTh)]; % [x y z] Eckpunkte der Träger in Vektorschreibweise
patch('Faces', fac,'Vertices',vert3,'FaceColor','c');            % Erzeugen der Gefärbten Flächen (Polygonen)   
