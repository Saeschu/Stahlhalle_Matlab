...
vert1= [-((bf1/2)-(Dim/2)) -((bf1/2)-(Dim/2)) -hf1; (bf1/2) -((bf1/2)-(Dim/2)) -hf1; (bf1/2) -((bf1/2)-(Dim/2)) 0; -((bf1/2)-(Dim/2)) -((bf1/2)-(Dim/2)) 0;...
    (bf1/2) (l + ((bf1/2)-(Dim/2))) 0; -((bf1/2)-(Dim/2)) (l + ((bf1/2)-(Dim/2))) 0; -((bf1/2)-(Dim/2)) (l+ ((bf1/2)-(Dim/2))) -hf1; (bf1/2) (l+ ((bf1/2)-(Dim/2))) -hf1]; % [x y z] Eckpunkte der Träger in Vektorschreibweise
patch('Faces', fac,'Vertices',vert1,'FaceColor','b');            % Erzeugen der Gefärbten Flächen (Polygonen)

%Fundament -Variante 2 Einzelfundament

vert1= [(b-(bf1/2)) -((bf1/2)-(Dim/2)) -hf1; (b+(bf1/2)-(Dim/2)) -((bf1/2)-(Dim/2)) -hf1; (b+(bf1/2)-(Dim/2)) -((bf1/2)-(Dim/2)) 0; (b-(bf1/2)) -((bf1/2)-(Dim/2)) 0;...
    (b+(bf1/2)) ((bf1/2)-(Dim/2)) 0; (b-((bf1/2)-(Dim/2))) ((bf1/2)-(Dim/2)) 0; (b-((bf1/2)-(Dim/2))) ((bf1/2)-(Dim/2)) -hf1; (b+(bf1/2)) ((bf1/2)-(Dim/2)) -hf1]; % [x y z] Eckpunkte der Träger in Vektorschreibweise
patch('Faces', fac,'Vertices',vert1,'FaceColor','b');            % Erzeugen der Gefärbten Flächen (Polygonen)
